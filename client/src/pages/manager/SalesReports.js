...
const SalesReports = () => {
    ...
    const handleZReport = async () => {
        const res = await fetch(`${HOST}/zreport`);
    ...
    const handleXReport = async () => {
        ...
        const res1 = await fetch(`${HOST}/xreportdefault`);
    ...
    return (
        <div className="container">
            <button type="button" onClick={handleZReport}>
                Create Z Report
            </button>

            <button type="button" onClick={handleXReport}>
                Create X Report
            </button>
            <p>{xprofit}</p>
            <p>{xtax}</p>
